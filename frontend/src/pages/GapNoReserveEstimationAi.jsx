...
// Auto-generated page for: No reserve-estimation AI

export default function GapNoReserveEstimationAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-reserve-estimation-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No reserve-estimation AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No reserve-estimation AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No reserve-estimation AI'}
        </button>
      </form>
