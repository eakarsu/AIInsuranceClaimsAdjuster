...
// Auto-generated page for: No subrogation-recovery optimizer

export default function GapNoSubrogationRecoveryOptimizer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-subrogation-recovery-optimizer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No subrogation-recovery optimizer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No subrogation-recovery optimizer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No subrogation-recovery optimizer'}
        </button>
      </form>
