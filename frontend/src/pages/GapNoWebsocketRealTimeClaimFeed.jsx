...
// Auto-generated page for: No WebSocket real-time claim feed

export default function GapNoWebsocketRealTimeClaimFeed() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-websocket-real-time-claim-feed', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No WebSocket real-time claim feed</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No WebSocket real-time claim feed</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No WebSocket real-time claim feed'}
        </button>
      </form>
