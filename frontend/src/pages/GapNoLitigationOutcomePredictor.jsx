...
// Auto-generated page for: No litigation-outcome predictor

export default function GapNoLitigationOutcomePredictor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-litigation-outcome-predictor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No litigation-outcome predictor</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No litigation-outcome predictor</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No litigation-outcome predictor'}
        </button>
      </form>
