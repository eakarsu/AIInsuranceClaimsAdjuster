...
// Auto-generated page for: No webhook surface for FNOL ingestion from carriers

export default function GapNoWebhookSurfaceForFnolIngestion() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhook-surface-for-fnol-ingestion', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No webhook surface for FNOL ingestion from carriers</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No webhook surface for FNOL ingestion from carriers</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No webhook surface for FNOL ingestion from carriers'}
        </button>
      </form>
