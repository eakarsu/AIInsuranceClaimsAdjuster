...
// Auto-generated page for: Computer-vision damage assessment from mobile-uploaded photo

export default function CfComputerVisionDamageAssessmentFromM() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-computer-vision-damage-assessment-from-m', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Computer-vision damage assessment from mobile-uploaded photo</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Computer-vision damage assessment from mobile-uploaded photos with cost estimation.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Computer-vision damage assessment from mobile-uploaded photo'}
        </button>
      </form>
