...
// Auto-generated page for: Fraud-ring detection correlating claims across customers, ad

export default function CfFraudRingDetectionCorrelatingClaims() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-fraud-ring-detection-correlating-claims-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Fraud-ring detection correlating claims across customers, ad</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Fraud-ring detection correlating claims across customers, adjusters, and providers.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Fraud-ring detection correlating claims across customers, ad'}
        </button>
      </form>
