...
// Auto-generated page for: Adjuster workload balancing using capacity and case complexi

export default function CfAdjusterWorkloadBalancingUsingCapaci() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-adjuster-workload-balancing-using-capaci', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Adjuster workload balancing using capacity and case complexi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Adjuster workload balancing using capacity and case complexity.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Adjuster workload balancing using capacity and case complexi'}
        </button>
      </form>
