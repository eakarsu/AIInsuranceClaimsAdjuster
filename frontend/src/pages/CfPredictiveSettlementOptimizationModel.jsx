...
// Auto-generated page for: Predictive settlement optimization modeling claim outcomes a

export default function CfPredictiveSettlementOptimizationModel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-settlement-optimization-model', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Predictive settlement optimization modeling claim outcomes a</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Predictive settlement optimization modeling claim outcomes and recommending early-vs-litigation strategy.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Predictive settlement optimization modeling claim outcomes a'}
        </button>
      </form>
