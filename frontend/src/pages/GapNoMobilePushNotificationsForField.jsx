...
// Auto-generated page for: No mobile push notifications for field adjusters

export default function GapNoMobilePushNotificationsForField() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile-push-notifications-for-field', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No mobile push notifications for field adjusters</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No mobile push notifications for field adjusters</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No mobile push notifications for field adjusters'}
        </button>
      </form>
