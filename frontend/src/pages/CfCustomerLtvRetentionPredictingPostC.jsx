...
// Auto-generated page for: Customer LTV retention predicting post-claim churn and recom

export default function CfCustomerLtvRetentionPredictingPostC() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-customer-ltv-retention-predicting-post-c', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Customer LTV retention predicting post-claim churn and recom</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Customer LTV retention predicting post-claim churn and recommending retention offers.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Customer LTV retention predicting post-claim churn and recom'}
        </button>
      </form>
