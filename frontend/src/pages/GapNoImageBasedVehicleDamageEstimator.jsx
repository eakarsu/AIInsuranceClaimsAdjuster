...
// Auto-generated page for: No image-based vehicle damage estimator (damageAssessments s

export default function GapNoImageBasedVehicleDamageEstimator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-image-based-vehicle-damage-estimator', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No image-based vehicle damage estimator (damageAssessments s</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No image-based vehicle damage estimator (damageAssessments stores records but no vision AI exposed)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No image-based vehicle damage estimator (damageAssessments s'}
        </button>
      </form>
