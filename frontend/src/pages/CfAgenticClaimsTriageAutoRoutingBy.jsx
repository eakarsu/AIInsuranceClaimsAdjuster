...
// Auto-generated page for: Agentic claims triage auto-routing by urgency and initiating

export default function CfAgenticClaimsTriageAutoRoutingBy() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-claims-triage-auto-routing-by', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic claims triage auto-routing by urgency and initiating</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic claims triage auto-routing by urgency and initiating workflows.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic claims triage auto-routing by urgency and initiating'}
        </button>
      </form>
